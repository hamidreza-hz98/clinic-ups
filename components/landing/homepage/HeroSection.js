    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: "relative", zIndex: 2 }}>
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1.05fr .95fr" }, alignItems: "center", gap: { xs: 4, md: 8 } }}>
          ...
          <Box ref={visualRef} sx={{ order: { xs: 1, md: 2 }, position: "relative", width: "100%", ml: 0, minHeight: { xs: 420, md: 590 }, display: "grid", placeItems: "center", transition: "transform .35s ease-out", willChange: "transform" }}>
            {/* Legacy morphing bolt core intentionally replaced by the reusable atomic navigation system. */}
            <EnergyAtomMenu ariaLabel="دسترسی سریع به صفحات کلینیک یو پی اس" />
          </Box>
        </Box>
      </Container>
    </Box>
