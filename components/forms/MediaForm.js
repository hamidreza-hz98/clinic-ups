  ...
  const handleUploadMedia = async (data) => {
    try {
      ...
      if (data.file instanceof File) {
        ...
        formData.append("existingFile", data.file.path);
        formData.append("existingMimeType", data.file.mimeType || "");
        formData.append("existingSize", data.file.size || 0);
        formData.append("existingOriginalName", data.file.originalname || "");
      }

      // 2. append all other fields normally
